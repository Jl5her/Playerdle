...
export default function ColorsHowToPlay({ className, onOpenCalendar }: Props) {
  const isLocal = import.meta.env.DEV

  return (
    <div className={className}>
      <p className="text-primary-500 dark:text-primary-200 leading-relaxed my-2">
        Guess the U.S. state from the team colors of its professional sports franchises. You have 5
        guesses.
      </p>
      ...
      <div className="mt-4">
        ...
        <p className="text-sm text-primary-500 dark:text-primary-200 leading-relaxed">
          Each row shows the three brand colors of one of the state's NFL, MLB, NBA, or NHL teams.
          The league and team name stay hidden — you have to recognize the colors.
        </p>
        ...
        <div className="mt-3 rounded-lg bg-primary-100/60 dark:bg-primary-800/40 px-3 py-3">
          <div className="text-[10px] uppercase tracking-wider text-primary-500 dark:text-primary-200 text-center mb-1">
            Example: if the answer is California
          </div>

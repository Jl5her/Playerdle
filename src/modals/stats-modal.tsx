...
export default function StatsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-1000 p-4">
      <div
        className={`bg-primary-50 dark:bg-primary-900 rounded-lg w-full border-2 border-primary-300 dark:border-primary-700 relative ${
          showStatsOnly ? "max-w-2xl max-h-[90vh] overflow-auto" : "max-w-lg"
        }`}

    ...
    <div className="flex flex-col items-center px-6 py-8 gap-5 max-w-sm mx-auto overflow-y-auto flex-1">
      ...
      <div className="w-full flex flex-col gap-1">
        <p className="text-sm text-primary-500 dark:text-primary-200 leading-6">
          Guess the {sport.displayName} player in <strong>6 tries</strong>. After each guess, the
          tiles will change color to show how close your guess was.
        </p>
      </div>
      ...
      <div className="w-full flex flex-col gap-1">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm text-primary-500 dark:text-primary-200 leading-6">
            Exact match
          </span>
        </div>
        <div className="flex items-center gap-2.5">
      ...
      <div className="w-full flex flex-col gap-1">
        <h3 className="text-base font-bold text-primary-900 dark:text-primary-50 mb-1">
          Categories
        </h3>
        <p className="text-sm text-primary-500 dark:text-primary-200 leading-6">
      ...
      <div className="w-full flex flex-col gap-1">
        ...
        <p className="text-sm text-primary-500 dark:text-primary-200 leading-6">
          <strong>Daily</strong> &mdash; Everyone gets the same {sport.displayName} player each day
          (midnight reset).
        </p>
        <p className="text-sm text-primary-500 dark:text-primary-200 leading-6">

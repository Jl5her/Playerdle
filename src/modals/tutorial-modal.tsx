      ...
      >
        ...
        <div className="p-6">
          <p className="text-primary-500 dark:text-primary-200 leading-relaxed my-2">
            Guess the mystery {sport.displayName} player in 6 tries. Each guess reveals clues across
          ...
          <div className="mt-6">
            <h3 className="text-lg font-semibold text-primary-900 dark:text-primary-50 mb-3">
              Example
            </h3>
            <div className="flex flex-col items-center">
              ...
              <div className="flex gap-1 justify-center">
                {sport.columns.map(column => (
                  <div
                    key={column.id}
                    className={`grid-cell-size flex items-center justify-center font-bold leading-tight p-1 rounded-md border-2 border-primary-300 dark:border-primary-700 cursor-default text-primary-50 ${getExampleBg(column.example.status)}`}
                  >
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <div className="flex items-center gap-3">
                ...
                <p className="text-primary-900 dark:text-primary-50 m-0 text-sm">
                  Green = Correct match
                </p>
              </div>
              <div className="flex items-center gap-3">

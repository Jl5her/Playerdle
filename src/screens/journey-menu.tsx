import { faChartColumn, faRoute } from "@fortawesome/free-solid-svg-icons"
...
const TITLE = "JOURNEY"
const SUBTITLE = "Guess the NFL player from their career path."
          ...
          <div className="flex flex-col gap-3">
            <div className="min-w-44 mx-auto flex items-center gap-2">
              <button
                ...
                onClick={playedToday ? onPlayArcade : onPlayDaily}
              >
                {playedToday ? (
                  <span className="flex flex-col items-center leading-tight">
                    <span className="text-base">Arcade</span>
                    <span className="text-[10px] font-medium opacity-75 -mt-0.5">Daily</span>
                  </span>
                ) : (
                  "Daily"
                )}

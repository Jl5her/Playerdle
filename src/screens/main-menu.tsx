      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        {menuItems.map(item => {
          ...
          return (
            <button
              key={item.screen}
              className={`flex flex-col items-center px-4 py-4 rounded-lg border-2 ${isLocked
            ...
            >
              ...
              <span className={`text-xs mt-1 ${isLocked ? "text-primary-600 dark:text-primary-400" : "text-primary-500 dark:text-primary-200"}`}>

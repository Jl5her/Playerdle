...
function buildShareText(
  ...
  const score = won
    ? `${guesses.length}/${COLLEGECOURT_MAX_GUESSES}`
    : `X/${COLLEGECOURT_MAX_GUESSES}`
...
export default function CollegeCourtGame({
  mode,
  onModeChange,
  onGameOver,
  archiveDateKey,

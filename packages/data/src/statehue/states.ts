...
export const COLORS_STATES: ColorsState[] = [
  {
    ...
    teams: [
      ...
      { name: "Phoenix Suns", league: "NBA", colors: ["#1D1160", "#E56020", "#F9A01B"] },
    ],
  },
  {
    id: "CA",
    ...
    teams: [
      ...
      { name: "Los Angeles Chargers", league: "NFL", colors: ["#0080C6", "#FFC20E", "#002A5E"] },
      ...
      { name: "San Diego Padres", league: "MLB", colors: ["#2F241D", "#FFC425", "#FFFFFF"] },
      ...
      { name: "Anaheim Ducks", league: "NHL", colors: ["#F47A38", "#B9975B", "#000000"] },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Colorado Rockies", league: "MLB", colors: ["#33006F", "#C4CED4", "#000000"] },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Orlando Magic", league: "NBA", colors: ["#0077C0", "#C4CED4", "#000000"] },
      { name: "Florida Panthers", league: "NHL", colors: ["#C8102E", "#041E42", "#B9975B"] },
      { name: "Tampa Bay Lightning", league: "NHL", colors: ["#002868", "#FFFFFF", "#000000"] },
    ],
  },
  {
    id: "GA",
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Chicago White Sox", league: "MLB", colors: ["#27251F", "#C4CED4", "#FFFFFF"] },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Detroit Red Wings", league: "NHL", colors: ["#CE1126", "#FFFFFF", "#000000"] },
    ],
  },
  {
    id: "MN",
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Pittsburgh Penguins", league: "NHL", colors: ["#FCB514", "#000000", "#FFFFFF"] },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Memphis Grizzlies", league: "NBA", colors: ["#5D76A9", "#12173F", "#F5B112"] },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "San Antonio Spurs", league: "NBA", colors: ["#C4CED4", "#000000", "#FFFFFF"] },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Milwaukee Bucks", league: "NBA", colors: ["#00471B", "#EEE1C6", "#0077C5"] },
    ],
  },
]

...
const PALETTE_NAMES: Record<string, [string, string, string]> = {
  // Texas
  Texas: ["Orange", "White", "Gray"],
  "Texas A&M": ["Maroon", "White", "Gray"],
  "Texas Tech": ["Red", "Black", "White"],
  Baylor: ["Green", "Gold", "White"],
  Houston: ["Red", "White", "Gray"],
  TCU: ["Purple", "Black", "White"],
  SMU: ["Blue", "Red", "White"],
  Rice: ["Navy", "Gray", "White"],
  "North Texas": ["Green", "Black", "White"],
  // North Carolina
  UNC: ["Blue", "Navy", "White"],
  Duke: ["Blue", "White", "Black"],
  "NC State": ["Red", "White", "Black"],
  "Wake Forest": ["Black", "Gold", "White"],
  "App State": ["Black", "Gold", "White"],
  Charlotte: ["Green", "White", "Black"],
  Davidson: ["Red", "Black", "White"],
  "East Carolina": ["Purple", "Gold", "White"],
  // California
  USC: ["Red", "Gold", "White"],
  UCLA: ["Blue", "Gold", "White"],
  Stanford: ["Red", "White", ""],
  Cal: ["Navy", "Gold", "White"],
  "San Diego State": ["Red", "Black", "White"],
  "Saint Mary's": ["Navy", "Red", "White"],
  "Fresno State": ["Red", "Navy", "White"],
  "Cal Poly": ["Green", "Gold", "White"],
  "Long Beach State": ["Black", "Gold", "White"],
  "UC Santa Barbara": ["Navy", "Gold", "White"],
  "UC Davis": ["Navy", "Gold", "White"],
  // Florida
  Florida: ["Orange", "Blue", "White"],
  "Florida State": ["Maroon", "Gold", "White"],
  Miami: ["Orange", "Green", "White"],
  UCF: ["Black", "Gold", "White"],
  "South Florida": ["Green", "Gold", "White"],
  "Florida Atlantic": ["Navy", "Red", "White"],
  "Florida Gulf Coast": ["Navy", "Green", "White"],
  Jacksonville: ["Blue", "Gold", "White"],
  Stetson: ["Green", "Gold", "White"],
  // New York
  Syracuse: ["Orange", "Navy", "White"],
  "St. John's": ["Red", "White", "Black"],
  Buffalo: ["Blue", "White", "Black"],
  Columbia: ["Light Blue", "Navy", "White"],
  Iona: ["Maroon", "Gold", "White"],
  Army: ["Black", "Gold", "White"],
  ...
  Ohio: ["Green", "White", "Black"],
  Akron: ["Navy", "Gold", "White"],
  "Cleveland State": ["Green", "White", "Black"],
  "Youngstown State": ["Red", "White", "Black"],
  // Pennsylvania
  "Penn State": ["Navy", "White", ""],
  Pitt: ["Blue", "Gold", "White"],
  Villanova: ["Navy", "Light Blue", "White"],
  Temple: ["Maroon", "White", "Black"],
  "Saint Joseph's": ["Red", "Gray", "White"],
  Duquesne: ["Red", "Blue", "White"],
  Penn: ["Navy", "Red", "White"],
  Bucknell: ["Orange", "Navy", "White"],
  "La Salle": ["Blue", "Gold", "White"],
  // Virginia
  Virginia: ["Navy", "Orange", "White"],
  "Virginia Tech": ["Maroon", "Orange", "White"],
  VCU: ["Black", "Gold", "White"],
  "James Madison": ["Purple", "Gold", "White"],
  "George Mason": ["Green", "Gold", "White"],
  "Old Dominion": ["Blue", "Light Blue", "White"],
  ...
  "Indiana State": ["Blue", "White", "Black"],
  "Ball State": ["Red", "White", "Black"],
  IUPUI: ["Red", "Gold", "White"],
  ...
  "Holy Cross": ["Purple", "White", "Black"],
  Merrimack: ["Navy", "Red", "White"],
  Bryant: ["Black", "Gold", "White"],
  // Illinois
  Illinois: ["Orange", "Navy", "White"],
  Northwestern: ["Purple", "White", "Black"],
  DePaul: ["Navy", "Red", "White"],
  "Loyola Chicago": ["Maroon", "Gold", "White"],
  "Illinois State": ["Red", "White", "Black"],
  "Northern Illinois": ["Red", "Black", "White"],
  UIC: ["Navy", "Red", "White"],
  Bradley: ["Red", "White", "Black"],
  "Southern Illinois": ["Maroon", "White", "Black"],
  // Iowa
  Iowa: ["Black", "Gold", ""],
  "Iowa State": ["Red", "Gold", "White"],
  Drake: ["Blue", "White", "Black"],
  "Northern Iowa": ["Purple", "Gold", "White"],
  // Kentucky
  Kentucky: ["Blue", "White", "Black"],
  Louisville: ["Red", "Black", "White"],
  "Western Kentucky": ["Red", "White", "Black"],
  "Murray State": ["Navy", "Gold", "White"],
  "Morehead State": ["Navy", "Gold", "White"],
  "Eastern Kentucky": ["Maroon", "White", "Gold"],
  Bellarmine: ["Blue", "Gold", "White"],
  // Louisiana
  LSU: ["Purple", "Gold", "White"],
  Tulane: ["Green", "Blue", "White"],
  Louisiana: ["Red", "White", "Black"],
  "Louisiana Tech": ["Blue", "Red", "White"],
  "Southeastern Louisiana": ["Green", "White", "Black"],
  McNeese: ["Blue", "Gold", "White"],
  "New Orleans": ["Navy", "White", "Black"],
  // Mississippi
  "Ole Miss": ["Red", "Navy", "White"],
  "Mississippi State": ["Maroon", "White", "Gray"],
  "Southern Miss": ["Black", "Gold", "White"],
  "Jackson State": ["Navy", "White", "Black"],
  "Mississippi Valley State": ["Green", "White", "Black"],
  // Oklahoma
  Oklahoma: ["Red", "Cream", "White"],
  "Oklahoma State": ["Orange", "Black", "White"],
  Tulsa: ["Navy", "Gold", "Red"],
  "Oral Roberts": ["Navy", "Gold", "White"],
  Lamar: ["Red", "White", "Black"],
  // South Carolina
  "South Carolina": ["Maroon", "Black", "White"],
  Clemson: ["Orange", "Purple", "White"],
  "College of Charleston": ["Maroon", "Gold", "White"],
  "Coastal Carolina": ["Teal", "Gold", "White"],
  Winthrop: ["Red", "Gold", "White"],
  "South Carolina State": ["Green", "Red", "White"],
  // Tennessee
  Tennessee: ["Orange", "White", "Gray"],
  Memphis: ["Blue", "Gray", "White"],
  Vanderbilt: ["Black", "Gold", "White"],
  "Middle Tennessee": ["Blue", "White", "Black"],
  ETSU: ["Navy", "Gold", "White"],
  Belmont: ["Blue", "Gold", "White"],
  "Tennessee State": ["Green", "Navy", "White"],
  "Tennessee Tech": ["Purple", "Gold", "White"],
  "UT Martin": ["Orange", "Navy", "White"],
  // Utah
  Utah: ["Red", "Black", "White"],
  BYU: ["Navy", "White", "Gray"],
  "Utah State": ["Blue", "White", "Gray"],
  "Weber State": ["Purple", "White", "Black"],
  ...
  Troy: ["Maroon", "Gold", "White"],
  Samford: ["Navy", "Gold", "White"],
  "Jacksonville State": ["Red", "White", "Black"],
  Montevallo: ["Purple", "Gold", "White"],
  // Arizona
  Arizona: ["Red", "Navy", "White"],
  "Arizona State": ["Maroon", "Gold", "White"],
  "Grand Canyon": ["Purple", "White", "Black"],
  NAU: ["Navy", "Gold", ""],
  // Colorado
  Colorado: ["Black", "Gold", "White"],
  "Colorado State": ["Green", "Gold", "White"],
  "Air Force": ["Blue", "Silver", "White"],
  Denver: ["Maroon", "Gold", "White"],
  "Colorado Mesa": ["Blue", "Red", "White"],
  // Connecticut
  UConn: ["Navy", "Red", "White"],
  Yale: ["Blue", "White", "Black"],
  Quinnipiac: ["Navy", "Gold", "White"],
  "Central Connecticut": ["Blue", "Light Blue", "White"],
  "Sacred Heart": ["Red", "White", "Black"],
  Fairfield: ["Red", "White", "Black"],
  // Georgia
  Georgia: ["Red", "Black", "White"],
  "Georgia Tech": ["Gold", "Navy", "White"],
  "Georgia State": ["Blue", "Red", "White"],
  "Georgia Southern": ["Blue", "White", "Gold"],
  Mercer: ["Orange", "Navy", "White"],
  "Kennesaw State": ["Gold", "Black", "Purple"],
  "Georgia Court": ["Blue", "Gold", "White"],
  // Kansas
  Kansas: ["Red", "Blue", "White"],
  "Kansas State": ["Purple", "Silver", "White"],
  "Wichita State": ["Gold", "Black", "White"],
  "Fort Hays State": ["Black", "Gold", "White"],
  Washburn: ["Blue", "Gold", "White"],
  // Michigan
  Michigan: ["Gold", "Navy", "White"],
  "Michigan State": ["Green", "White", "Black"],
  Oakland: ["Black", "Gold", "White"],
  "Central Michigan": ["Maroon", "Gold", "White"],
  "Western Michigan": ["Brown", "Gold", "White"],
  "Eastern Michigan": ["Green", "Black", "White"],
  "Detroit Mercy": ["Navy", "Red", "White"],
  // Missouri
  Missouri: ["Black", "Gold", "White"],
  "Saint Louis": ["Blue", "Gold", "White"],
  "Missouri State": ["Maroon", "White", "Gray"],
  "Kansas City": ["Blue", "Gold", "White"],
  // New Jersey
  Rutgers: ["Red", "Black", "White"],
  "Seton Hall": ["Blue", "Gray", "White"],
  Princeton: ["Orange", "Black", "White"],
  Rider: ["Red", "White", "Black"],
  Monmouth: ["Navy", "Gold", "White"],
  "Saint Peter's": ["Blue", "Gold", "White"],
  "Fairleigh Dickinson": ["Blue", "Gold", "White"],
  // Rhode Island
  Providence: ["Black", "White", "Silver"],
  "Rhode Island": ["Light Blue", "Navy", "White"],
  ...
  "Western Washington": ["Blue", "Gold", "White"],
  "Central Washington": ["Red", "Black", "White"],
  // Oregon
  Oregon: ["Green", "Gold", "White"],
  "Oregon State": ["Orange", "Black", "White"],
  Portland: ["Purple", "Gold", "White"],
  "Portland State": ["Purple", "White", "Gray"],
  Pacific: ["Orange", "Black", "White"],
  "Southern Oregon": ["Red", "Black", "White"],
  // Maryland
  Maryland: ["Red", "Gold", "Black"],
  Towson: ["Gold", "Black", "White"],
  "Morgan State": ["Blue", "Orange", "White"],
  UMBC: ["Gold", "Black", "White"],
  Navy: ["Navy", "Gold", "White"],
  "Loyola Maryland": ["Green", "Gold", "White"],
  "Coppin State": ["Blue", "Gold", "White"],
  "Mount St. Mary's": ["Navy", "Red", "White"],
  // Nebraska
  Nebraska: ["Red", "Cream", ""],
  Creighton: ["Blue", "White", "Navy"],
  "Nebraska-Omaha": ["Blue", "Gold", "White"],
  "Nebraska-Kearney": ["Blue", "Gold", "White"],
  // Arkansas
  Arkansas: ["Red", "White", ""],
  "Arkansas State": ["Red", "Black", "White"],
  "Little Rock": ["Red", "Navy", "White"],
  "Central Arkansas": ["Purple", "Gray", "White"],
  // West Virginia
  "West Virginia": ["Navy", "Gold", "White"],
  Marshall: ["Green", "Black", "White"],
  "WV Mountaineers": ["Navy", "Gold", "White"],
  // Idaho
  "Boise State": ["Blue", "Orange", "White"],
  Idaho: ["Silver", "Gold", ""],
  "Idaho State": ["Orange", "Black", ""],
  // Wisconsin
  Wisconsin: ["Red", "White", ""],
  Marquette: ["Navy", "Gold", "White"],
  "Wisconsin-Milwaukee": ["Black", "Gold", "White"],
  "Wisconsin-Green Bay": ["Green", "White", "Black"],
  // North Dakota
  "North Dakota State": ["Gold", "Green", "White"],
  "North Dakota": ["Green", "White", "Black"],
  // South Dakota
  "South Dakota State": ["Blue", "Gold", "White"],
  "South Dakota": ["Red", "White", "Black"],
  // Siena
  Siena: ["Green", "Gold", "White"],
}
...
function team(name: string): ColorsTeam {
  ...
  const colorNames = PALETTE_NAMES[name]
  return { name, league: conference, colors, ...(colorNames ? { colorNames } : {}) }
}
